...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Initial First Admin</div>

                <div class="card-body">
                    <form method="POST" action="/myadmin/register">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small>!Secret Key is word from 10 character+numbers using to login after using {yourdomain}/myadmin/{secret key}</small>
